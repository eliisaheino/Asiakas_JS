...
document.getElementById("etunimi").focus();//Kursorin vieminen etunimi-kenttään kun sivu ladataan

//Haetaan muutettavan asiakkaan tiedot. Kutsutaan backin GET-metodia ja välitetään kutsun mukana muutettavan tiedon asiakas_id
...
function vieTiedot(){	
	...
	fetch("asiakkaat",{//Läheteään kutsu backendiin
	      method: 'PUT',
	      body:formJsonStr
	    })
