...
<title>Asiakkaiden tietojen hallinta</title>
<style>
.oikealle{
	text-align: right;
}
...
<script>
haeTiedot();	
document.getElementById("hakusana").focus();//Kursorin vienti hakusana-kenttään sivun latauksen yhteydessä
